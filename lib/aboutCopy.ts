...
export const ABOUT_COPY: Record<AboutLocale, AboutCopy> = {
  ...
  ti: {
    ...
    missionTitle: 'ዕላማና',
    missionBody:
      'ዕላማና ግድላዊ መጋድል ቋንቋ ናብ ድልድይ ምቕያር እዩ። ኣብ መላእ ዓለም ን1ይ ወለድ፣ 2ይ ወለድን ንዘፍቅር ቋንቋን ትግርኛ ብኽብሪ ንምዝራብ፣ ንምንባብን ንምጽሓፍን ንምኽንያት ንኽእል ንሕግዝ። ጥንታዊ ታሪኽ ምስ ዘመናዊ ተሳትፎ ዝገብር መሳርሒ ትምህርቲ ብምሕላፍ፣ ፊደል ንኹሉ ኣብ ኩሉ ቦታ ንምምሃር ኣበለጸትናዮ ኣሎና።',
